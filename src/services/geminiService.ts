...
- Suggested key, scale, and **song-specific chord progression** (bar-by-bar where useful)
- Melodic phrasing & motifs (tie to **topline** phrases where available)
- Rhythmic feel & syncopation techniques aligned to **genre** and **vibe**
...
- Integrate **arrangement flow, transitions, contrast, and energy management** into the **Structural Blueprint** table notes for each section.
- **Do not** create a separate \"Arrangement Flow & Energy Management\" section.
${structuralBlueprint}
