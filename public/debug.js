...
// Add simple DOM-based test component
window.addEventListener('load', function() {
  console.log("Adding a simple test component directly to the DOM");
  
  const testDiv = document.createElement('div');
  testDiv.style.backgroundColor = '#4CAF50';
  testDiv.style.color = 'white';
  testDiv.style.padding = '20px';
  testDiv.style.margin = '20px';
  testDiv.style.borderRadius = '5px';
  testDiv.textContent = "This is a test div (not React-based)";
  ...
  console.log("Successfully added test div to DOM");
});
